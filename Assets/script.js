...
function writePassword() {
    ...
    alert("Please specify the password criteria answering the following questions")
    var passwordCase = prompt("¿Do you want it to use lowercase (1), uppercase (2) or both (3)?");
    ...
    var passwordNumeric = confirm("¿Do you want it to include numbers?");
    var passwordCharacters = confirm("¿Do you want it to include special characters?");
    var passwordLength = prompt("¿What length do you want the password to have (8-128 characters)?");
      if(parseInt(passwordLength, 10) < 8 || parseInt(passwordLength, 10) > 128){
